...
Queue.enqueue method will raise ValueError exception if the value being added is None, Nan, Inf, and -Inf.  Queue.dequeue method will return None if the queue is empty.
